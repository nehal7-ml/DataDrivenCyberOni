...
function AuthorCard({ author }: { author: { id: string, image?: userImage, firstName: string, lastName: string } }) {
    return (<div className="w-full flex flex-col gap-5 p-10 justify-center items-center dark:bg-zinc-900 rounded-md">
        <Link href={`/blogs/author/${author.id}?page=1`} >
            <div className="w-20 h-20 rounded-full overflow-hidden">
                {author.image ? <Image src={author.image.src} alt="author-dp" height={50} width={50} />
                    :
