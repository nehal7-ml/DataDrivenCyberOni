...
<<<<<<< HEAD
                <Image className=" w-full h-full object-contain" src={'/images/cta.png'} alt="cta-image" height={500} width={500}></Image>
            </div>
            <div className="relative lg:flex lg:flex-col lg:justify-center mx-10 -top-20 lg:top-auto">
                <div className="font-abel text-5xl p-2 text-center lg:text-left">Get exponential reach via AI Marketing</div>
=======
