...
function EmailLetter() {
    return (
        <div className="rounded-lg lg:flex lg:flex-row gap-5 bg-gradient-purple">
            <div className="relative flex-1 h-60 lg:h-full lg:w-1/2 -top-20 lg:top-0 lg:translate-y-0 overflow-hidden">
                <Image className=" w-full h-full object-contain" src={'/cta.png'} alt="image" height={300} width={300}></Image>
            </div>
            <div className="relative mx-10 -top-20 lg:top-auto">
                ...
                <div className="flex flex-col gap-5 lg:flex-row justify-center items-center">
                    ...
                    ></input>
                    <button className="flex-1 bg-black text-white rounded-full w-fit flex p-3 gap-2" type="submit">
