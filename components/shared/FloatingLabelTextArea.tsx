        ...
        <>
            <div className={props.className}>
                <div className="relative my-3">
                    ...
                    <label
                        className="dark:bg-transparent dark:text-gray-100 dark:backdrop-blur-sm dark:peer-placeholder-shown:bg-inherit absolute left-3 top-0 mb-2 block  -translate-y-3 rounded-full bg-white px-1  text-sm  font-bold  text-gray-900 transition-transform peer-placeholder-shown:translate-y-3   peer-placeholder-shown:bg-white peer-focus:-translate-y-3 peer-focus:text-blue-500 peer-focus:backdrop-blur-lg"
                        htmlFor={props.name}
                    >
                        {props.placeholder}
                    </label>
