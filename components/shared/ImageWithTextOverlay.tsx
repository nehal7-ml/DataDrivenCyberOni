...
function ImageWithTextOverlay({ title, modal, image, width, height }: props) {
    ...
    return (
        ...
        <div className="relative w-full h-full rounded-lg overflow-hidden">
            <Image className="z-0 object-cover" src={image} alt="text-overlay" width={width} height={height}></Image>
            ...
            {modal && <Modal setShowModal={setOpenModal} showModal={openModal} >
                <div className="relative container mx-auto bg-gray-50 rounded-xl dark:bg-gray-800 p-5">
